...
class BaseAvatar:
    def __init__(self, opt):
        ...
        self.watermark_text = getattr(self.opt, 'watermark', 'LiveTalking')
    ...
    def process_frames(self,quit_event):
        ...
        while not quit_event.is_set():
            ...
            cv2.putText(combine_frame, self.watermark_text, (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (128,128,128), 1)
